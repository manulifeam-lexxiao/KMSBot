import type { IndexStatusResponse } from "../../../types/settings";
    ...
    <section className="settings-card">
      ...
      {data && (
        <div className="settings-card__body">
          ...
          <div className="settings-card__row">
            <span className="settings-card__label">Indexed Documents</span>
            <span>{data.indexed_documents}</span>
          </div>
          <div className="settings-card__row">
            <span className="settings-card__label">Indexed Chunks</span>
